...
const allProjects = [
	{
		...
		description:
			"Dashboard interativo para análise de vendas com gráficos e métricas em tempo real.",
		category: "backend",
	},
	{
		id: 2,
		...
		description:
			"Landing page responsiva, com design moderno, animações sutis e foco em conversão para campanhas de marketing digital e lançamentos de produtos.",
		category: "frontend",
	},
	{
		id: 3,
		...
		description:
			"Blog colaborativo para resenhas de livros, filmes e séries, com sistema de comentários, avaliações e integração com redes sociais.",
		category: "frontend",
	},
	{
		id: 4,
		...
		description:
			"API RESTful robusta para integração entre sistemas, com autenticação JWT, documentação Swagger e testes automatizados.",
		category: "backend",
	},
	{
		id: 5,
		...
		description:
			"Sistema completo de gestão empresarial, incluindo módulos de estoque, financeiro, RH e relatórios customizáveis.",
		category: "gestao",
	},
	{
		id: 6,
		...
		description:
			"Portal para escritórios de advocacia, com área do cliente, upload seguro de documentos e agenda de audiências integrada.",
		category: "frontend",
	},
	{
		id: 7,
		...
		description:
			"Aplicativo mobile para acompanhamento de saúde, agendamento de consultas, controle de medicamentos e notificações personalizadas.",
		category: "mobile",
	},
	{
		id: 8,
		...
		description:
			"Portfólio visual para designers e ilustradores, com galerias de imagens, animações e integração com Behance e Dribbble.",
		category: "design",
	},
	{
		id: 9,
		...
		description:
			"Loja virtual moderna, com carrinho de compras, checkout seguro, painel de administração e integração com meios de pagamento.",
		category: "frontend",
	},
];
		...
		<div className="bg-pattern bg-no-repeat bg-top bg-cover min-h-screen">
			...
			<section className="w-full flex flex-col items-center justify-center pt-28 pb-10 px-4">
				<div className="max-w-2xl w-full flex flex-col items-center text-center gap-4">
					...
					<p className="text-lg md:text-xl text-blue-100 font-light mt-2 mb-4">
						Descubra portfólios de profissionais de diversas áreas de tecnologia,
						design e inovação. Encontre inspiração, faça networking e acompanhe as
			...
			<section className="w-full flex flex-col items-center bg-transparent px-4 pt-2 pb-20">
				...
				<div className="flex flex-col md:flex-row gap-4 mb-10 w-full max-w-4xl">
					...
					{/* filtro com seta customizada */}
					<div className="relative">
						<select
							value={filter}
							onChange={(e) => setFilter(e.target.value)}
							onMouseDown={() => setFilterOpen((s) => !s)}
							onBlur={() => setFilterOpen(false)}
							className="px-4 py-2 pr-12 rounded-lg bg-indigo-900/80 border border-indigo-700 text-blue-100 focus:outline-none focus:ring-2 focus:ring-blue-400 transition appearance-none"
						>
							{filters.map((f) => (
						...
						<svg
							...
							className={`absolute top-1/2 -translate-y-1/2 right-6 w-4 h-4 text-blue-100 transition-transform cursor-pointer ${filterOpen ? "rotate-180" : ""}`}
							viewBox="0 0 12 8"
							fill="none"
					...
					{/* ordenação com seta customizada */}
					<div className="relative">
						<select
							value={order}
							onChange={(e) => setOrder(e.target.value)}
							onMouseDown={() => setOrderOpen((s) => !s)}
						...
						<svg
							...
							className={`absolute top-1/2 -translate-y-1/2 right-6 w-4 h-4 text-blue-100 transition-transform cursor-pointer ${orderOpen ? "rotate-180" : ""}`}
							viewBox="0 0 12 8"
							fill="none"
							xmlns="http://www.w3.org/2000/svg"
							aria-hidden="true"
